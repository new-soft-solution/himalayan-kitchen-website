...
export default function SectionHeader({
  ...
  return (
    <div className={centered ? "text-center" : ""}>
      <h2
        className={`font-satisfy font-normal subtitle flex items-center gap-[15px] ${
      ...
      <h1
        className={`title font-jakarta font-semibold mb-4 lg:mb-[20px] xl:mb-[33px] ${
          light ? "text-eerie-black" : "text-white"
        }`}
      >
        {title}
      </h1>
